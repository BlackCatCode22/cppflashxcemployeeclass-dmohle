...
int main()
{
    ...
    string line;
    ifstream myAnimalFile("C:/2023spring/midtermProgram/arrivingAnimals.txt");
    ...
    // Make sure you are reading the file. You will see 16 lines in your output window. If 
    // you do not see the 16 arriving animals, fix this before you go on.
    // Quick personal story: I spent a couple hours trying to debug my code when I wasn't seeing the 
    // animals. The problem was that I accidentally deleted everything in arrivingAnimals.txt. The
    // file was opened and closed properly, but somehow I deleted its contents.

    // Now that we know how to do file io, let's create four arrays of names (one array of names
    //   for each species).
    ...
    ifstream myAnimalNames("C:/2023spring/midtermProgram/animalNames.txt");
    // Read the file into an array (like we did with myAnimalFile)
    // As always, run your program after this and before you read the proper lines into arrays.
    ...
    // This code works by finding an animal name from the start of the string to the comma
    ...
    // Now that you have validated your file io, read the contents into a one-dimensional array
    
    // Create a 1-D array
    string arrAnimals[16];
     
    myAnimalFile.open("C:/2023spring/midtermProgram/arrivingAnimals.txt");
    ...
    // At this point, make sure you have an array with 16 elements. Each element will be one line of the
    ...
    for (int lineNum = 0; lineNum < 16; lineNum++) {
       ...
       // at this point, you should have 16 groups of four lines that look something like this:
       //
       // numYears = 4
       // position = 25
       // birthSeason = spri
